...
{{"tenant_refund_pct": <0-100>, "confidence": <0-100>, "reason": "<appeals ruling reason>"}}"""
    ...
    def _finalize_payout(self, dispute_id: str) -> None:
        ...
        self.dispute_counts[t_key] = self.dispute_counts.get(t_key, u256(0)) + u256(1)
        self.dispute_counts[l_key] = self.dispute_counts.get(l_key, u256(0)) + u256(1)
    ...
    def get_trust_score(self, user: Address) -> u256:
        return self.trust_scores.get(str(user), u256(100))
